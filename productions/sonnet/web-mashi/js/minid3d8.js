...
export class MiniD3D8 {
  ...
  _syncMatrices() {
    ...
    if (this._matDirty) {
      ...
      // MASHI FORK: the pack pins lighting=fixed, so the normal transform is
      // always the D3D-correct inverse-transpose; `worldMatrix3` and the
      // 'world' legacy arm (kept in the readable build so the two stay A/B-able)
